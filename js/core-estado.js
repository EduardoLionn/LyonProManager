    ...
    'Atacante/Aberto': 7, 'Atacante/Fisico': 7, 'Atacante/Armador': 7, 'Atacante/Velocidade': 7, 'Atacante/Versátil': 7 
        ...
        function dbPadrao() {
            return {
                clube: { nome: '', saveName: '', nomeTecnico: '', nomeDiretor: '', nomeAuxiliar: '', partidaAuxiliar: null, historicoPartidasAuxiliar: [], comandosJogo: [], ultimoPrestigioRegistrado: null, aprovacaoTorcida: 50, alvosTorcida: {}, liga: '', temporadaAtual: '25/26', orcamento: 0, gastoAtual: 0, arrecadadoAtual: 0, mediaGastoHistorico: 0, mediaArrecadadoHistorico: 0, competicaoContinental: 'Nenhuma', notaDiretoria: 6.5, objetivosTemporada: '', diretoriaConfigurada: false, exigenciasDiretoria: [], partidas: [], plantel: [], historicoTemporadas: [], socialFeed: [], chatHistory: { diretoria: [], auxiliar: [] } },
                selecao: { nome: '', saveName: '', nomeTecnico: '', nomeDiretor: '', nomeAuxiliar: '', partidaAuxiliar: null, historicoPartidasAuxiliar: [], comandosJogo: [], ultimoPrestigioRegistrado: null, aprovacaoTorcida: 50, alvosTorcida: {}, liga: 'Seleção Tier 2 (OVR 74)', temporadaAtual: 'Ciclo 2030', orcamento: 0, gastoAtual: 0, arrecadadoAtual: 0, mediaGastoHistorico: 0, mediaArrecadadoHistorico: 0, competicaoContinental: 'Nenhuma', notaDiretoria: 6.5, objetivosTemporada: '', diretoriaConfigurada: false, exigenciasDiretoria: [], partidas: [], plantel: [], historicoTemporadas: [], socialFeed: [], chatHistory: { diretoria: [], auxiliar: [] } }
            };
        }
        let db = dbPadrao();
