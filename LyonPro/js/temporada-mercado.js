        async function concluirTemporadaAutomatica() {
            ...
            salvarDados(); alert("Temporada concluída! 📥 Aproveite e baixe um backup do seu save (botão na barra lateral) — é rápido e evita perder seu progresso."); atualizarFiltroTemporadas(); ajustarInterfaceSave(); mudarAba('tab-diretoria');
        }
